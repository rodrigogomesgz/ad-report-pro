  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          nav.push("/report?connected=meta");
        }, 2000);
      }, 3000);
      ...
      <div className="w-full max-w-lg animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <Text size="lg" c="dimmed">
            Autorize o acesso às suas campanhas do Facebook e Instagram
          </Text>
        </div>
        ...
        <Card className="p-8 shadow-medium">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <Text size="sm">Campanhas do Facebook e Instagram</Text>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle size={16} className="text-green-500" />
                    <Text size="sm">Métricas de alcance e engajamento</Text>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle size={16} className="text-green-500" />
                    <Text size="sm">Dados de conversões e ROI</Text>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <Text size="sm" c="dimmed">
                  ...
                  Você pode revogar o acesso a qualquer momento no Facebook.
                </Text>
              </div>
          ...
          {connectionStatus === "connecting" && (
            <div className="text-center space-y-4">
              ...
              <Text fw={600}>Conectando com Meta Ads...</Text>
              <Text size="sm" c="dimmed">
